...
export class PatchedSharedIniFileCredentials extends AWS.SharedIniFileCredentials {
    loadRoleProfile(creds, roleProfile, callback) {
        ...
        if (this.disableAssumeRole) {
            throw AWS.util.error(new Error("Role assumption profiles are disabled. " +
                ...
                this.profile +
                " from " +
                creds.filename), { code: "SharedIniFileCredentialsProviderFailure" });
        }
        var self = this;
    ...
    sourceProfileCredentials(sourceProfile, profiles) {
        ...
        if (typeof sourceProfileExistanceTest !== "object") {
            throw AWS.util.error(new Error("source_profile " +
                sourceProfile +
                " using profile " +
                this.profile +
                " does not exist"), { code: "SharedIniFileCredentialsProviderFailure" });
        }
